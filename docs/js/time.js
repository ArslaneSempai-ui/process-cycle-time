 ...
 */
import { generate, byCase, days, ACTIVITIES } from "./events.js";
import { isMain } from "./cli.js";
export function perCase(events = generate()) {
...
export function overall(times = perCase()) {
...
export function perStep(events = generate()) {
 ...
 */
export function slowestAgainstCostliest(steps = perStep()) {
...
if (isMain(import.meta)) {
    ...
    for (const s of steps) {
        console.log(`${s.activity.padEnd(24)}${s.perCase.toFixed(2).padStart(10)}` +
